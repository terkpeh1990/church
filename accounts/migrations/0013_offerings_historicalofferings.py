# Generated by Django 4.1.1 on 2022-10-24 10:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0012_historicalpv_payment_history_type_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_by', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='omodifiedby', to=settings.AUTH_USER_MODEL)),
                ('sub_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.sub_accounts')),
            ],
        ),
        migrations.CreateModel(
            name='HistoricalOfferings',
            fields=[
            ...
            options={
                'verbose_name': 'historical offerings',
                'verbose_name_plural': 'historical offeringss',
