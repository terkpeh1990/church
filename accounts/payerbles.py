    ...
    if request.method == "POST":
        ...
        if ff is None :
            ...
            if form.is_valid():
                ...
                All_Transaction.objects.create(transaction_date=today,sub_code=subcode,description=st.description + " "+ " Using" + " "+ subcode.sub_description,amount=-cc.amount,church=st.church,type=st.type,account_period=ff)
                General_Ledger.objects.create(transaction_date=today,sub_code=subcode,description=st.description + " "+ " Using" + " "+ subcode.sub_description,cedit=cc.amount,church=st.church,type=st.type,transactionref=st.id,account_period=ff)
